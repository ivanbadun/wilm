...
<form method="get" id="searchform" class="search" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<button type="submit" name="submit" class="search__submit  btn btn-smallest btn-primary" id="searchsubmit" aria-label="<?php _e('Submit search','default'); ?>"><?php _e( 'Search', 'default' ); ?></button>
</form>
<!-- END of search form -->
